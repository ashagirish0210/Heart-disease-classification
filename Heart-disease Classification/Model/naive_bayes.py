...
def train_naive_bayes_model(data_path='data/heart_disease_uci.csv'):
    ...
    with open('models_pkl/naive_bayes_model.pkl', 'wb') as f:
        pickle.dump({
            'pipeline': pipeline,
...
if __name__ == "__main__":
    train_naive_bayes_model(data_path='data/heart_disease_uci.csv')
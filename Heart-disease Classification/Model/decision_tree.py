...
def train_decision_tree_model(data_path='data/heart_disease_uci.csv'):
    """Train Decision Tree model and save it"""
    ...
    with open('models_pkl/decision_tree_model.pkl', 'wb') as f:
        pickle.dump({
            'pipeline': pipeline,
